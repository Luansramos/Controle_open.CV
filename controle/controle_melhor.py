...
hands = mp.solutions.hands.Hands(
    static_image_mode=False,       # Modo dinâmico (detecção contínua)
    max_num_hands=2,               # Número máximo de mãos
    #min_detection_confidence=0.5,  # Confiança mínima para detectar uma mão
    #min_tracking_confidence=0.5    # Confiança mínima para o rastreamento contínuo
)
